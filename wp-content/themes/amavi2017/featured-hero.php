<div class="featured-hero row large-wrapper">
	...
	<div class="featured-hero__thumbnail col-s-12 col-l-offset-4 col-l-8">
		<div class="featured-hero__thumbnail-wrap">
			<a href="<?php the_permalink(); ?>"><div class="featured-hero__thumbnail-image" style="background-image:url('<?php echo wp_get_attachment_url( get_post_thumbnail_id() );?>');"></div></a>
		</div>
	</div>
